    ...
    return (
        <div className="quiz-page">
            ...
            <div className="container" style={{ maxWidth: '680px', margin: '0 auto' }}>
                ...
                >
                {currentQuestion.icon && <div className="quiz-icon">{currentQuestion.icon}</div>}
...
const LOCAL_CAREERS = {
    ...
    'ms-abroad': { id: 'ms-abroad', slug: 'ms-abroad', title: 'MS Abroad (USA/Germany)', category: 'Higher Studies', salaryRange: '₹40–100 LPA', riskLevel: 'High', demandLevel: 'Very High', icon: '' },
    ...
    'saas-startup': { id: 'saas-startup', slug: 'saas-startup', title: 'SaaS Startup', category: 'Entrepreneurship', salaryRange: 'Variable', riskLevel: 'High', demandLevel: 'High', icon: '' },
    ...
    'ms-computer-science': { id: 'ms-computer-science', slug: 'ms-computer-science', title: 'MS in Computer Science', category: 'Higher Studies', salaryRange: '₹40–100 LPA', riskLevel: 'High', demandLevel: 'Very High', icon: '' },
    ...
    'drdo-scientist': { id: 'drdo-scientist', slug: 'drdo-scientist', title: 'DRDO Scientist B', category: 'Government', salaryRange: '₹10-12 LPA', riskLevel: 'Low', demandLevel: 'High', icon: '' },
    ...
    // Arts
    'ias-ips-ifs-officer': { id: 'ias-ips-ifs-officer', slug: 'ias-ips-ifs-officer', title: 'IAS / IPS / IFS Officer', category: 'Government', salaryRange: '₹8–15 LPA', riskLevel: 'Low', demandLevel: 'High', icon: '' },
    ...
    'llb-law': { id: 'llb-law', slug: 'llb-law', title: 'LLB / Patent Law', category: 'Higher Studies', salaryRange: '₹5–20 LPA', riskLevel: 'Medium', demandLevel: 'Medium', icon: '' },
    'freelance-agency': { id: 'freelance-agency', slug: 'freelance-agency', title: 'Creative Freelance Agency', category: 'Entrepreneurship', salaryRange: '₹5–50 LPA', riskLevel: 'Low', demandLevel: 'High', icon: '' }
};
...
const FALLBACK_QUESTIONS = [
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'low', label: 'Low — I prefer job security', value: 'Low' },
            { id: 'medium', label: 'Medium — Balanced risk is fine', value: 'Medium' },
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'govt', label: 'Government / Public Sector (PSUs)', value: 'Govt' },
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'low', label: 'Low — I prefer stable IT services firms', value: 'Low' },
            { id: 'medium', label: 'Medium — MNCs or established product companies', value: 'Medium' },
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'solve', label: 'Problem Solving & Operations management', value: 'ProblemSolving' },
        ],
    },
    {
        ...
        icon: '',
        options: [
            { id: 'low', label: 'Low — Prefer stable fixed salary and hours', value: 'Low' },
            { id: 'medium', label: 'Medium — Base salary plus performance bonuses', value: 'Medium' },
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'govt', label: 'Government / Public Administration', value: 'Government' },
        ],
    },
    {
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'stable', label: 'Stable — Steady growth, compliance, and auditing', value: 'Stable' },
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'labs', label: 'Government Scientific Labs (ISRO, DRDO, CSIR)', value: 'GovtLabs' },
    ...
    // --- Arts & Humanities Track ---
    {
        ...
        options: [
            ...
            { id: 'hist', label: 'History, Geography & Archeology', value: 'History' },
        ],
    },
    {
        ...
        icon: '',
        options: [
            { id: 'write', label: 'Writing, Editing & Content Creation', value: 'Writing' },
            { id: 'civil', label: 'Civil Services & Public Administration', value: 'CivilServices' },
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'stable', label: 'Stable — Government, NGO, or institutional jobs', value: 'Stable' },
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'sscje', label: 'SSC JE / CDS — For government technical jobs', value: 'SSCJE' },
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'metro', label: 'Major metros (Bangalore, Hyderabad, Pune, Delhi)', value: 'Metro' },
            { id: 'tier2', label: 'Tier 2 cities or home state', value: 'Tier2' },
            { id: 'abroad', label: 'Open to relocating abroad', value: 'Abroad' },
    ...
    // --- Computer Applications extra questions (7-10) ---
    {
        ...
        options: [
            ...
            { id: 'cloud', label: 'Cloud & DevOps (AWS, Docker, Linux)', value: 'Cloud' },
        ],
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'mfg', label: 'Manufacturing, Logistics & Operations', value: 'Manufacturing' },
        ],
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'policy', label: 'Policy Advisor or Government Officer (RBI, IAS)', value: 'PolicyAdvisor' },
    ...
    // --- Commerce & Finance extra questions (7-10) ---
    {
        ...
        options: [
            ...
            { id: 'legal', label: 'Legal & Compliance Knowledge', value: 'Legal' },
        ],
    },
    {
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'sec', label: 'Job security and stable income', value: 'Security' },
            { id: 'grow', label: 'High earning potential and rapid growth', value: 'Growth' },
            { id: 'prest', label: 'Prestigious designations and institutional status', value: 'Prestige' },
    ...
    // --- Sciences extra questions (7-10) ---
    {
        ...
        options: [
            ...
            { id: 'write', label: 'Scientific Writing & Research Review', value: 'Writing' },
        ],
    },
    {
        ...
        options: [
            ...
            { id: 'large', label: 'Large organization — Structured government or industry lab', value: 'LargeOrg' },
        ],
    },
    {
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'high', label: 'High — I use Figma, Canva, Adobe, or video editing tools', value: 'HighDigital' },
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'govt', label: 'Government officials, IAS officers & policy makers', value: 'GovtNetwork' },
    ...
    },
    {
        ...
        icon: '',
        options: [
            { id: 'civil', label: 'IAS / IPS Officer or Diplomat', value: 'CivilServant' },
